  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url();?>index.php" class="logo"><b>TRAVELINK</b></a>
            <!--logo end-->
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.php#">
                                    ...
                                    <span class="subject">
                                    <span class="from">Wafa Arya</span>
                            ...
                            <li>
                                <a href="index.php#">
                                    ...
                                    <span class="subject">
                                    <span class="from">Bundahara</span>
                                    <span class="time">40 mins.</span>
                                    </span>
                                    <span class="message">
                                     Uangnya sudah ibu transfer.
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="index.php#">
                                    ...
                                    <span class="subject">
                                    <span class="from">Adiyasa Akmilian</span>
                                    <span class="time">2 hrs.</span>
                                    </span>
                                    <span class="message">
                                        Oke, terimakasih aghna..
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="index.php#">
                                    ...
                                    <span class="subject">
                                    <span class="from">Silva Elida</span>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.php"><img src="<?=base_url();?>assets/img/na2.jpg" class="img-circle" width="60"></a></p>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?=base_url();?>index.php#" class="go-top">
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            image: '<?=base_url();?>assets/img/na2.jpg',
